...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'way_of_working-code_linting-hdi', '~> 1.1.1'
  spec.add_dependency 'way_of_working-code_of_conduct-contributor_covenant', '~> 1.0.1'
  spec.add_dependency 'way_of_working-decision_record-madr', '~> 1.0.2'
  ...
  spec.add_dependency 'way_of_working-versioning-semver', '~> 1.0.0'
